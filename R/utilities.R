...
#' prepara0
#'
#' @param x data.frame the covariate matrix
#' @param y numeric the response vector
#' @param family character gaussian
#' @param index numeric
#' @param robu integer
#'
#' @return list
#'
prepara0 <- function(x,y,family="gaussian",index=NULL,robu=NULL){
...
#' addIntercept add intercept column to design matrix
#'
#' @param x
#' @param check
#'
